...
import { cva, mergeClasses, type VariantProps } from '../../lib/utils'
...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-transparent p-0 text-white [&>button]:hidden"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="group peer text-white md:block"
        data-state={state}
