...
import { useEnrollmentCreateMutation } from './useEnrollmentCreateMutation'

vi.mock('@spacedock/cargo-bay', () => ({
  SessionHandling: { getActiveSessionKey: () => 'key' },
}))

describe('useEnrollmentCreateMutation', () => {
  ...
  it('returns the response from a Successfully mutation', async () => {
    ...
    const {
      result: { current },
    } = renderHook(() => useEnrollmentCreateMutation({ onSuccess, onError }), {
      wrapper,
    })
