...
const patterns = [
  ...
  },
  {
    ...
    styles: {
      ...
      backgroundSize: 'var(--pattern-size, 40px) var(--pattern-size, 40px)',
      backgroundImage:
        'linear-gradient(45deg, var(--pattern-color) 12.50%, transparent 12.50%, transparent 50%, var(--pattern-color) 50%, var(--pattern-color) 62.50%, transparent 62.50%, transparent 100%)',
    },
  },
  {
    name: 'triangles',
...
/**
 * @cite fork of https://github.com/thillmann/tailwindcss-bg-patterns/tree/main
 */
