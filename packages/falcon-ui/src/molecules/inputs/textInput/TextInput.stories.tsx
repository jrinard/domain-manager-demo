...
import { SurfaceForStory, SurfaceStoryArgTypes } from '@falcon/storybook'

const meta: Meta<typeof TextInput> = {
  title: 'DL: Falcon/Molecules/Inputs/Legacy Text Input',
  component: TextInput,
  tags: ['autodocs'],
}
...
export const ExampleOnSurface: Story = {
  argTypes: {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of a Input being on a surface ',
      },
    },
  },
  render: ({ onSurface }) => (
    <SurfaceForStory
      surface={onSurface == null || onSurface === 'auto' ? 'light' : onSurface}
    >
      <TextInput
        placeholder="Search"
        leadingIcon="search"
