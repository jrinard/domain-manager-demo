...
import { BAAllEventsListItem } from './BAAllEventsListItem'

const meta: Meta<typeof BAAllEventsListItem> = {
  title: 'Domain Ui/Organisms/BA All Events List Item',
  component: BAAllEventsListItem,
  tags: ['autodocs'],
}

export default meta
type Story = StoryObj<typeof BAAllEventsListItem>
