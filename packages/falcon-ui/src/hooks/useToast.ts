...
// @cite generated from https://ui.shadcn.com/docs/components/toast
import * as React from 'react'
import { ToasterToastProps } from '../molecules/toast/Toaster'
...
const toastComingSoon = (
  props?: Omit<Toast, 'description' | 'variant'> & { ticket?: string }
) => {
  return toast({
    title: 'Coming soon...',
    description:
      props?.ticket && props?.ticket?.length > 0
        ? `Ticket ${props.ticket}`
        : 'No ticket',
    variant: 'info',
    ...props,
